...
export default function ClassSessionsClient({ sessions, targetDate, todayStr }: Props) {
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                          <div className="flex-1">
                            <div className="flex flex-wrap items-center gap-3 mb-2">
                              ...
                              >
                                {copiedId === s.id ? <CheckIcon className="w-3 h-3 text-green-500" /> : <Copy className="w-3 h-3" />}
